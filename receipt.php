...
<body>
	...
	<div class="main-wrapper receipt-main-cont">
		...
		<div class="container receipt-cont">
			...
			<h6 class="referenceNum-receipt">REFERENCE NUMBER: [ <span><?php //echo $_SESSION['reference_number'] ?></span> ] </h6>
			<div class="row">
				<?php 
			...
			<h3>Thank you for purchasing at GameHub!</h3>
			<p>Here is the Order No. <em><strong><?php echo $refNum ?></strong></em></p>
			<small>Please keep a copy of the order number for future references. An email was sent for the tracking the status or your purchase.</small>
			<?php unset($_SESSION['reference_number']); ?>
			<br>
