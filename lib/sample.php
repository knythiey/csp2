...
<div class="row catalog-items" id="catalog-items">
			...
			<?php 
				for ($i = 1; $i <= $page_count; $i++) {
				   if ($i === $page) { // this is current page ?>
				   	<li class="page-item active"><a class="page-link" href="sample.php?page=<?php echo $i ?>"><?php echo $i ?></a></li>
				   <?php } else { // show link to other page ?>
				   <li class="page-item"><a class="page-link" href="sample.php?page=<?php echo $i ?>#catalog-items"><?php echo $i ?></a></li>  
				<?php 
				   }
				}
			?>
