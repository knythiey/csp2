			...
			<div class="row">
				<div class="card-group">
					<?php foreach ($product_result as $key) { ?>	
						<div class="col-md-4">
							<div class="card">
								<a href="product.php?id=<?php echo $key['id'] ?>"><img class="card-img-top home-prod-img img-thumbnail img-fluid" src="<?php echo $key['product_image'] ?>" alt="Card image cap"></a>
								<div class="card-body">
