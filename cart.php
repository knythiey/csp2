							...
							<ul class="list-unstyled">
								<li class="media">
							    	...
							    	<div class="media-body cart-item-details">
							      		...
							      		<p class="mb-3 d-none d-md-block"><?php echo $prod['description'] ?></p>
							      		<span class="mb-3">Orders: </span>
										...
										<button class="btn btn-danger" id="delete-cart-item" onclick="deleteCartItem(<?php echo $key ?>)">Remove Item</button>
